...
export default function ProctoredTestPage() {
  ...
  const [questions] = useState([
    ...
    { id: 5, question: "Alisha accidentally pushed her '.env' file with sensitive credentials to GitHub. What git steps should she follow to permanently remove it from the repo’s history (without making the repo private)?"  },
