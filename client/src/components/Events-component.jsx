...
const handleClick = async () => {
  ...
  try {
    const response = await fetch(`http://${process.env.NEXT_PUBLIC_DJANGO_URL}/api/authentication/user`, {
      method: "GET",
    ...
    if (!data.test_given) {
      const updateResponse = await fetch(
        `http://${process.env.NEXT_PUBLIC_DJANGO_URL}/api/authentication/update-test-status/`,
        {
